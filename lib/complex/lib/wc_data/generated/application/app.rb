...
#<em>value</em> is a String
        ...
        def initialize
          ...
          @children['privacy-statement'] = {:name => 'privacy-statement', :class => HealthVault::WCData::Application::StatementInfo, :value => nil, :min => 0, :max => 1, :order => 11, :place => :element, :choice => 0 }
            
          
        
          
          @children['terms-of-use'] = {:name => 'terms-of-use', :class => HealthVault::WCData::Application::StatementInfo, :value => nil, :min => 0, :max => 1, :order => 12, :place => :element, :choice => 0 }
            
          
        
          
          @children['dtc-success-message'] = {:name => 'dtc-success-message', :class => HealthVault::WCData::Application::StatementInfo, :value => nil, :min => 0, :max => 1, :order => 13, :place => :element, :choice => 0 }
            
          
        
          
          @children['app-attributes'] = {:name => 'app-attributes', :class => HealthVault::WCData::Application::ApplicationAttributes, :value => nil, :min => 0, :max => 1, :order => 14, :place => :element, :choice => 0 }
            
          
        
          
          @children['app-type'] = {:name => 'app-type', :class => HealthVault::WCData::Types::String32, :value => nil, :min => 1, :max => 1, :order => 15, :place => :element, :choice => 0 }
          ...
          @children['master-app-id'] = {:name => 'master-app-id', :class => HealthVault::WCData::Types::Guid, :value => nil, :min => 0, :max => 1, :order => 16, :place => :element, :choice => 0 }
            
          
        
          
          @children['master-app-name'] = {:name => 'master-app-name', :class => HealthVault::WCData::Types::CultureSpecificString255, :value => nil, :min => 0, :max => 1, :order => 17, :place => :element, :choice => 0 }
            
          
        
          
          @children['created-date'] = {:name => 'created-date', :class => String, :value => nil, :min => 0, :max => 1, :order => 18, :place => :element, :choice => 0 }
            
          
        
          
          @children['updated-date'] = {:name => 'updated-date', :class => String, :value => nil, :min => 0, :max => 1, :order => 19, :place => :element, :choice => 0 }
