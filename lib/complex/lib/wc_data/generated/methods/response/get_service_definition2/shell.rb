...
#<em>value</em> is a String
        ...
        #<em>value</em> is a HealthVault::WCData::Methods::Response::GetServiceDefinition2::ShellRedirectToken
...
#<b>returns</b>: a HealthVault::WCData::Methods::Response::GetServiceDefinition2::ShellRedirectToken Array
        def redirect_token
        ...
        def initialize
          ...
          @children['redirect-token'] = {:name => 'redirect-token', :class => HealthVault::WCData::Methods::Response::GetServiceDefinition2::ShellRedirectToken, :value => Array.new, :min => 0, :max => 999999, :order => 3, :place => :element, :choice => 0 }
