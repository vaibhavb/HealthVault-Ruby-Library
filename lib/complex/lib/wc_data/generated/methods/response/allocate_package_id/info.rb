...
#<b>remarks</b>: This code is to be kept secret. If the code is lost, the application should call DeleteConnectPackage in order to delete it, then call CreateConnectPackage again in order to obtain a new identity code.
