...
#<em>value</em> is a String
        ...
        def initialize
          ...
          @children['id'] = {:name => 'id', :class => HealthVault::WCData::Types::Guid, :value => Array.new, :min => 0, :max => 999999, :order => 1, :place => :element, :choice => 235144282 }
          
        
          
          @children['key'] = {:name => 'key', :class => HealthVault::WCData::Thing::ThingKey, :value => Array.new, :min => 0, :max => 999999, :order => 2, :place => :element, :choice => 235144282 }
          
        
          
          @children['client-thing-id'] = {:name => 'client-thing-id', :class => HealthVault::WCData::Types::String255, :value => Array.new, :min => 0, :max => 999999, :order => 3, :place => :element, :choice => 235144282 }
