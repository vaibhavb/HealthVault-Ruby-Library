...
#<em>value</em> is a HealthVault::WCData::Vocab::VocabularyAuthorizations
        ...
        def initialize
          ...
          @children['valid-ip-prefixes'] = {:name => 'valid-ip-prefixes', :class => HealthVault::WCData::Types::String255nw, :value => nil, :min => 0, :max => 1, :order => 21, :place => :element, :choice => 0 }
            
          
        
          
          @children['vocabulary-authorizations'] = {:name => 'vocabulary-authorizations', :class => HealthVault::WCData::Vocab::VocabularyAuthorizations, :value => nil, :min => 0, :max => 1, :order => 22, :place => :element, :choice => 0 }
