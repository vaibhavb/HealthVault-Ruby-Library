module HealthVault
  ...
  module DeleteOpenQuery
      ...
      class Info < ComplexType
        ...
        #<b>REQUIRED</b>
        #<b>summary</b>: The identifier of the saved query that is to be deleted.
#<b>remarks</b>: When a query is saved by the SaveOpenQuery method a unique identifier is issued by the Microsoft Health Services. This identifier is used to delete the saved query by calling the DeleteOpenQuery method.
