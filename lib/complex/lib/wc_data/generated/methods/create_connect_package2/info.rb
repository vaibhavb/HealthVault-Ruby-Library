...
#<em>value</em> is a HealthVault::WCData::Thing::Thing2
        ...
        #<b>returns</b>: a HealthVault::WCData::Thing::Thing2
        def package
        ...
        #<em>value</em> is a HealthVault::WCData::Methods::CreateConnectPackage2::StreamedPackageBlobs
        def streamed_package_blobs=(value)
          @children['streamed-package-blobs'][:value] = value
        end
        
        #<b>returns</b>: a HealthVault::WCData::Methods::CreateConnectPackage2::StreamedPackageBlobs
        def streamed_package_blobs
          return @children['streamed-package-blobs'][:value]
        end
        ...
        def initialize
          ...
          @children['package'] = {:name => 'package', :class => HealthVault::WCData::Thing::Thing2, :value => nil, :min => 1, :max => 1, :order => 5, :place => :element, :choice => 0 }
            
          @children['package'][:value] = HealthVault::WCData::Thing::Thing2.new
            
          
        
          
          @children['streamed-package-blobs'] = {:name => 'streamed-package-blobs', :class => HealthVault::WCData::Methods::CreateConnectPackage2::StreamedPackageBlobs, :value => nil, :min => 0, :max => 1, :order => 6, :place => :element, :choice => 0 }
